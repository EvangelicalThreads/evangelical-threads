  ...
  if (!session) {
    return (
      <button
        ...
        className="fixed top-1/2 right-0 transform -translate-y-1/2 rotate-[-90deg] origin-right bg-[#14161a ] text-white text-sm px-4 py-2 rounded-tl-lg rounded-bl-lg shadow-lg hover:bg-yellow-600 transition z-50"
