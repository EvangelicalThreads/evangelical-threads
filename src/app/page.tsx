...
export default function HomePage() {
  ...
  useEffect(() => {
    const subscribed = localStorage.getItem('newsletterSignedUp');
    if (!subscribed) setShowNewsletter(true);
  }, []);
      ...
      <main className="flex flex-1 max-w-[1200px] mx-auto p-8 gap-20 relative items-start w-full">
        ...
        >
          ...
          <div className="mt-8 max-w-[220px]">
            <p className="text-lg font-light leading-snug">Faith driven fashion for</p>
            <p className="text-lg font-bold leading-snug mt-1">the bold and inspired</p>
          </div>
          <a
            href="/shop"
